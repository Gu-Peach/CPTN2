...
export default async function NxPage() {
  // 动态获取NX产品
  const products = await getProductsFromSupabase("woman/NX");
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold">NX 商品</h2>
