...
export default async function NqPage() {
  // 动态获取NQ产品
  const products = await getProductsFromSupabase("woman/NQ");
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold">NQ 商品</h2>
