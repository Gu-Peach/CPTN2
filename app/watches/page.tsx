...
export default async function WatchesPage() {
  // 获取每个分类的前4个产品
  const watchProducts = (await getProductsFromSupabase("SB/SB")) // 手表
    .slice(0, 4);
  const bandProducts = (await getProductsFromSupabase("SB/BD")) // 表带
    .slice(0, 4);
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold">手表商品</h2>
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">手表系列</h3>
                <Link href="/watches/watches">
                  <Button variant="outline" size="sm">
                    查看更多 →
                  </Button>
                </Link>
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">表带系列</h3>
                <Link href="/watches/bands">
                  <Button variant="outline" size="sm">
                    查看更多 →
                  </Button>
                </Link>
