...
export default async function WatchesSubPage() {
  const products = await getProductsFromSupabase("SB/SB"); // 手表
          ...
          <div className="container mx-auto px-4">
            ...
            {products.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-lg text-muted-foreground">暂无手表商品</p>
              </div>
            )}
          </div>
        </section>
