        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold">皮具皮饰商品</h2>
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">钱包系列</h3>
                <Link href="/leather/wallets">
                  <Button variant="outline" size="sm">
                    查看更多 →
                  </Button>
                </Link>
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">皮带系列</h3>
                <Link href="/leather/belts">
                  <Button variant="outline" size="sm">
                    查看更多 →
                  </Button>
                </Link>
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">皮包系列</h3>
                <Link href="/leather/bags">
                  <Button variant="outline" size="sm">
                    查看更多 →
                  </Button>
                </Link>
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">皮鞋系列</h3>
                <Link href="/leather/shoes">
                  <Button variant="outline" size="sm">
                    查看更多 →
                  </Button>
                </Link>
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">皮装系列</h3>
                <Link href="/leather/clothing">
                  <Button variant="outline" size="sm">
                    查看更多 →
                  </Button>
                </Link>
