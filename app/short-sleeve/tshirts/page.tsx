...
export default async function TShirtsPage() {
  const products = await getProductsFromSupabase("DX/TX"); // T恤
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative h-[300px] bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-900/20 dark:to-red-900/20">
