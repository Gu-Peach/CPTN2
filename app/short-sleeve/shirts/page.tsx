...
export default async function ShirtsPage() {
  const products = await getProductsFromSupabase("DX/CS"); // 衬衫
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative h-[300px] bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/20 dark:to-cyan-900/20">
